...
# Copyright (C) 2005- the SQLAlchemy authors and contributors
# <see AUTHORS file>
#
...
.. seealso::
    ...
    `CREATE INDEX <https://dev.mysql.com/doc/refman/5.0/en/create-home.html>`_ - MySQL documentation
...
https://dev.mysql.com/doc/refman/5.0/en/create-home.html
